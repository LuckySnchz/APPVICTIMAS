...
<html lang="en">
   ...
   <body>
    ...
    <h1 class="text-center" style="padding: 15px;">Eje C: Referentes Afectivos</h1>
    ...
    <form class="ejeC" action="/detalleconvivientevinculo" method="post">
    {{ csrf_field() }}
    <div class="form-group">
...
<!C1 Conviviente Nombre y Apellido>
    ...
    <input disabled type="text" class="form-control" name="nombre_y_apellido" id="victima_nombre_y_apellido" value="{{$nombre_y_apellido}}">
    <label for="bloqueo1" class="form-check-label">Se desconoce</label>
    <input disabled type="checkbox" id="bloqueo1" name="nombre_y_apellido" value="Se desconoce" onchange="checkC1(this)">
...
<!C2 Edad>
   ...
   <div class="form-group"{{ $errors->has('edad_conviviente') ? 'has-error' : ''}}>
    ...
    <input disabled name="edad_conviviente" value="{{$edad_conviviente}}"   id="edad_conviviente" class="form-control" type="text"><br>
    ...
    <input disabled name="edad_conviviente" value="0" id="edad_conviviente"  type="checkbox"  onchange="checkC2(this)">
    @endif
...
<!C4 Nivel educativo>
  ...
  <select disabled class="form-control" name="niveleducativo_id" value="{{old("niveleducativo_id")}}">
      <option value="" selected=disabled>Seleccionar...</option>
...
<!C5 Condiciones de trabajo>
  ...
  <select disabled class="form-control" name="condiciones_de_trabajo" value="{{$condiciones_de_trabajo}}"  id="condiciones_de_trabajo" >
      <option value="" selected=disabled>Seleccionar...</option>
