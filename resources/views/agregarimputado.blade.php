...
<html lang="en">
  ...
  <div class="" style="margin-left: 48%">
  <label class="font-weight-bold" style="color: red">Imputado/s: </label>
...
<!E3 Tipo de documentación>
  ...
  <input name="tipo_documento_otro"  id="tipo_documento_otro" class="form-control" type="text" value="{{old("tipo_documento_otro")}}">
...
<br>
  ...
  <div class="btn-1"> <button style="width:100%" type="submit" class="btn btn-primary col-xL" name="button">Agregar/Enviar</button><br><br></div><br>
  <a type="button" href="/agregarVictima" target="_self" style="width:100%;color: black" class="btn col-XL" class="btn btn-primary col-xL">AGREGAR NUEVA VICTIMA</button> </a><br><br><br>


 <a type="button" href="/agregarOrganismo" target="_self" style="width:100%; color:white;background-color:rgb(137, 210, 14)" class="btn col-XL" class="btn btn-danger">SIGUIENTE</button> </a><br><br>
