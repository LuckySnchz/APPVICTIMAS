...
<!-E11 Fiscalia/juzgado a cargo->
  ...
  <div class="form-group"
     ...
     <input disabled type="text" class="form-control" name="fiscalia_juzgado" id="datos_ente_judicial" value="{{$fiscalia_juzgado}}">
...
<!-E12I Causa o Id Judicial->
  ...
  <div class="form-group "{{ $errors->has('causa_id_judicial') ? 'has-error' : ''}}>
         ...
         <input disabled  type="text" class="form-control" name="causa_id_judicial" id="causa_id_judicial"value="{{$causa_id_judicial}}">
  


<label for="bloqueo12I" class="form-check-label">Se desconoce</label>
  <input disabled  type="checkbox" id="bloqueo12I" name="causa_id_judicial" value="Se desconoce" onchange="checkE12I(this)">
...
<!-E12 II Causa o Id Judicial->
  ...
  <div class="form-group "{{ $errors->has('otra_causa_id_judicial') ? 'has-error' : ''}}>
         ...
         <input disabled  type="text" class="form-control" name="otra_causa_id_judicial" id="otra_causa_id_judicial" value="{{$otra_causa_id_judicial}}">
 <label for="bloqueo12II" class="form-check-label">Se desconoce</label>

  <input disabled  type="checkbox" id="bloqueo12II" name="otra_causa_id_judicial" value="Se desconoce" onchange="checkE12II(this)">
...
<!-E12 III Causa o Id Judicial->
  ...
  <div class="form-group "{{ $errors->has('otra_otra_causa_id_judicial') ? 'has-error' : ''}}>
         ...
         <input disabled  type="text" class="form-control" name="otra_otra_causa_id_judicial" id="otra_otra_causa_id_judicial" value="{{$otra_otra_causa_id_judicial}}">
         <label for="bloqueo12I" class="form-check-label">Se desconoce</label>
     <input disabled  type="checkbox" id="bloqueo12III" name="otra_otra_causa_id_judicial" value="Se desconoce" onchange="checkE12III(this)">
