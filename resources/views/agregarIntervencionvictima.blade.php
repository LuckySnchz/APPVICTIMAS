...
<div id="victima" class="container jumbotron shadow p-3 mb-5 bg-white rounded">
...
@endforeach
 ...
 <a type="button" href="/home" onclick="return alert('Caso{{$casoActual->nombre_referencia}}Cargado Exitosamente!')" target="_self" style="width:100%;color: white;background-color: red" class="btn col-XL" class="btn btn-danger col-xl">FINALIZAR CARGA DE CASO - INICIO</button> </a><br><br>
...
<script type="text/javascript">
 function mostrarvictima(){
    divV = document.getElementById("victima");
