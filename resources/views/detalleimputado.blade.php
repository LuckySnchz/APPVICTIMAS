...
<!E1 Nombre y apellido Imputado>
  ...
  <input type="text" class="form-control" name="imputado_nombre_y_apellido" id="imputado_nombre_y_apellido" value="{{$nombre_y_apellido}}"><br>
...
<!E2 Apodo>
  ...
  <input type="text" class="form-control" name="apodo" id="apodo" value="{{$apodo}}">
...
<!E3 Tipo de documentación>
  ...
  @if($tipo_documento_id == 9||$errors->first('tipo_documento_otro'))
  ...
  <div class="">
  <input name="tipo_documento_otro"  id="imputado_tipo_documento_otro" class="form-control" type="text" value="{{$imputado->tipo_documento_otro}}">
...
<!E4 Nro documento>
 @if($tipo_documento_id ==1||$tipo_documento_id==2||$tipo_documento_id ==3||$tipo_documento_id==4||$tipo_documento_id ==5||$tipo_documento_id ==6||$tipo_documento_id ==9)
...
<div class="form-group" id="nrodoc" {{ $errors->has('documento_nro') ? 'has-error' : ''}}>
  ...
  <input type="text" class="form-control" name="documento_nro" placeholder="" id="imputado_documento" value="{{$documento_nro}}">
...
<!E7 Existencia de antecedentes penales>
  ...
  @if($antecedentes_id  == 1||$errors->first('antecedentes'))
  ...
  <input type="text" class="form-control" name="antecedentes" id="antecedentes" value="{{$antecedentes}}">
  <label for="bloqueo6" class="form-check-label">Se desconoce</label>
...
@if($detenido == 1||$errors->first('lugar_de_alojamiento'))
...
<input type="text" class="form-control" name="lugar_de_alojamiento" id="lugar_de_alojamiento" value="{{$lugar_de_alojamiento}}">
<label for="bloqueo6" class="form-check-label">Se desconoce</label>
...
<!E10 Defensoría>
  ...
  <input type="text" class="form-control" name="defensoria_numero" id="defensoria_numero" value="{{$defensoria_nro}}">
  <label for="bloqueo6" class="form-check-label">Se desconoce</label>
